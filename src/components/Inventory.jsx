...
export default function Inventory() {
  ...
  const loadProducts = async () => {
    try {
      const res = await axios.get("http://https://inventory-backend-final-1.onrender.com/api/inventory");
  ...
  const loadHistory = async () => {
    try {
      const res = await axios.get(
        "http://https://inventory-backend-final-1.onrender.com/api/inventory/history",
      );
      setHistory(res.data);
    } catch (err) {
      console.log(err);
  ...
  const damageStock = async () => {
    ...
    try {
      await axios.post(
        `http://https://inventory-backend-final-1.onrender.com/api/inventory/damage?productId=${action.productId}&qty=${action.qty}&remarks=${action.remarks}`,
      );
  ...
  const returnStock = async () => {
    ...
    try {
      await axios.post(
        `http://https://inventory-backend-final-1.onrender.com/api/inventory/return?productId=${action.productId}&qty=${action.qty}&remarks=${action.remarks}`,
      );
  ...
  const adjustStock = async () => {
    ...
    try {
      await axios.post(
        `http://https://inventory-backend-final-1.onrender.com/api/inventory/adjust?productId=${action.productId}&qty=${action.qty}&mode=${action.mode}&remarks=${action.remarks}`,
      );
