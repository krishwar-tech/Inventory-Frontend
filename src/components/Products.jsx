...
export default function Products() {
  ...
  const loadProducts = async () => {
    const res = await fetch("http://https://inventory-backend-final-1.onrender.com/api/products");
  ...
  const loadStats = async () => {
    try {
      const res = await fetch("http://https://inventory-backend-final-1.onrender.com/api/products/stats");
      const data = await res.json();
      setStats(data);
    } catch {}
  };
  ...
  const loadCategories = async () => {
    try {
      const res = await fetch("http://https://inventory-backend-final-1.onrender.com/api/masters/categories");
      const data = await res.json();
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://https://inventory-backend-final-1.onrender.com/api/products/${id}`, {
        method: "DELETE",
      });
  ...
  const handleDeactivate = async (id) => {
    await fetch(`http://https://inventory-backend-final-1.onrender.com/api/products/deactivate/${id}`, {
      method: "PUT",
    });
  ...
  const handleActivate = async (id) => {
    await fetch(`http://https://inventory-backend-final-1.onrender.com/api/products/activate/${id}`, {
      method: "PUT",
    });
  ...
  const handleApprove = async (p) => {
    ...
    await fetch(`http://https://inventory-backend-final-1.onrender.com/api/products/approve/${p.id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handlePrice = async (p) => {
    ...
    await fetch(`http://https://inventory-backend-final-1.onrender.com/api/products/price/${p.id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleBarcodeResult = async (code) => {
    try {
      const res = await fetch(
        `http://https://inventory-backend-final-1.onrender.com/api/products/scan/${code}`,
      );
